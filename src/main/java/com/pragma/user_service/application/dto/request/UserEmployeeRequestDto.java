...
public class UserEmployeeRequestDto {
    ...
    @Schema(
            description = UserRequestConstantsOpenApi.ID_RESTAURANT_DESCRIPTION,
            example = UserRequestConstantsOpenApi.ID_RESTAURANT_EXAMPLE
    )
    @NotNull(message = UserRequestConstants.ID_RESTAURANT_MUST_MANDATORY)
